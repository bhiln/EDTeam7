...
#define MSGT_I2C_MOTOR_RQST 42
#define MSGT_I2C_SENSOR_RQST 43
...
#define MSGT_TIMER1 11 ////
#define MSGT_MAIN1 20
#define	MSGT_OVERRUN 21 ////
#define MSGT_UART_DATA 30 ////
#define MSGT_I2C_DBG 40 //
#define	MSGT_I2C_SENSOR_DATA 41 //
#define MSGT_I2C_QE_DATA 42
#define MSGT_I2C_RQST 43 //
#define MSGT_I2C_MASTER_SEND_COMPLETE 44 //
#define MSGT_I2C_MASTER_SEND_FAILED 45 //
#define MSGT_I2C_MASTER_RECV_COMPLETE 46 //
#define MSGT_I2C_MASTER_RECV_FAILED 47 //
#define MSGT_SENSOR_DATA 50 ////
#define MSGT_SENSOR_DATA_RQST 51

#endif

>>>>>>> FETCH_HEAD:PIC Motor/src/src/maindefs.h
