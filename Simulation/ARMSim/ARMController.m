classdef ARMController < handle
    ...
    methods(Static = true)
        ...
        function [ listeningFor ] = sendMotorForward5()
            ...
            str = sprintf('%s%s%s%s%s%s',ntimes_Char, bin2dec(sprintf('%s', dec2bin(50, 8))), bin2dec(sprintf('%s', dec2bin(35, 8))), bin2dec(sprintf('%s', dec2bin(36, 8))), bin2dec(sprintf('%s', dec2bin(255, 8))), bin2dec(sprintf('%s', dec2bin(0, 8))));
