...
The framework must be able to handle quickly processing large amounts of complex information. In the 1960’s, development of a roving vehicle for surface exploration of the planet Mars demonstrated the need to have the framework on the vehicle to help eliminate lag. This implementation proved useful when tested with terrain that was not smooth and level. \cite{Bonissone}
